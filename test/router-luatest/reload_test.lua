...
local upgrade_helpers = require('test.luatest_helpers.upgrade')
...
g.before_all(function()
    ...
    local copy_root = vardir .. '/vshard_copy'
    fio.rmtree(copy_root)
    g.vshard_copy_path = copy_root .. '/override'
    --
    ...
    --
    g.vshard_lua_path = upgrade_helpers.vshard_copy_new(vtest.sourcedir,
                                                        g.vshard_copy_path)
